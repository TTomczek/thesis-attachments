...
public class DiscordIT extends BaseIT {
    ...
    static Stream<Arguments> testScenariosProvider() {
        return Stream.of(
                Arguments.of(
                        ...
                        List.of("list_my_guilds", "list_messages", "list_guild_channels")
                ),
                Arguments.of(
                        2,
