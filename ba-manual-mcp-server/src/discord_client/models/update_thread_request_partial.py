...
class UpdateThreadRequestPartial(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if auto_archive_duration (nullable) is None
        # and model_fields_set contains the field
        if self.auto_archive_duration is None and "auto_archive_duration" in self.model_fields_set:
            _dict['auto_archive_duration'] = None
