...
class MessageAllowedMentionsRequest(BaseModel):
    ...
    """ # noqa: E501
    parse: Optional[Annotated[List[Optional[StrictStr]], Field(max_length=1521)]] = None
    users: Optional[Annotated[List[Optional[Annotated[str, Field(strict=True)]]], Field(max_length=100)]] = None
    roles: Optional[Annotated[List[Optional[Annotated[str, Field(strict=True)]]], Field(max_length=100)]] = None
