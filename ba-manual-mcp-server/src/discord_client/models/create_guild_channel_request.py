...
class CreateGuildChannelRequest(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if video_quality_mode (nullable) is None
        # and model_fields_set contains the field
        if self.video_quality_mode is None and "video_quality_mode" in self.model_fields_set:
            _dict['video_quality_mode'] = None

        # set to None if default_auto_archive_duration (nullable) is None
        # and model_fields_set contains the field
        if self.default_auto_archive_duration is None and "default_auto_archive_duration" in self.model_fields_set:
            _dict['default_auto_archive_duration'] = None
        ...
        # set to None if default_sort_order (nullable) is None
        # and model_fields_set contains the field
        if self.default_sort_order is None and "default_sort_order" in self.model_fields_set:
            _dict['default_sort_order'] = None

        # set to None if default_forum_layout (nullable) is None
        # and model_fields_set contains the field
        if self.default_forum_layout is None and "default_forum_layout" in self.model_fields_set:
            _dict['default_forum_layout'] = None

        # set to None if default_tag_setting (nullable) is None
        # and model_fields_set contains the field
        if self.default_tag_setting is None and "default_tag_setting" in self.model_fields_set:
            _dict['default_tag_setting'] = None
