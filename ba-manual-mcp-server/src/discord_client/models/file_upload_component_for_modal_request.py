...
class FileUploadComponentForModalRequest(BaseModel):
    ...
    min_values: Optional[Annotated[int, Field(le=10, strict=True, ge=0)]] = None
    max_values: Optional[Annotated[int, Field(le=10, strict=True, ge=1)]] = None
    required: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["type", "id", "custom_id", "min_values", "max_values", "required"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FileUploadComponentForModalRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FileUploadComponentForModalRequest from a dict"""
        if obj is None:
            return None
