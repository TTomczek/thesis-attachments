...
class StageInstanceResponse(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if guild_scheduled_event_id (nullable) is None
        # and model_fields_set contains the field
        if self.guild_scheduled_event_id is None and "guild_scheduled_event_id" in self.model_fields_set:
            _dict['guild_scheduled_event_id'] = None
