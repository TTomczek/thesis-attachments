...
class GuildPatchRequestPartial(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if verification_level (nullable) is None
        # and model_fields_set contains the field
        if self.verification_level is None and "verification_level" in self.model_fields_set:
            _dict['verification_level'] = None

        # set to None if default_message_notifications (nullable) is None
        # and model_fields_set contains the field
        if self.default_message_notifications is None and "default_message_notifications" in self.model_fields_set:
            _dict['default_message_notifications'] = None

        # set to None if explicit_content_filter (nullable) is None
        # and model_fields_set contains the field
        if self.explicit_content_filter is None and "explicit_content_filter" in self.model_fields_set:
            _dict['explicit_content_filter'] = None
        ...
        # set to None if afk_channel_id (nullable) is None
        # and model_fields_set contains the field
        if self.afk_channel_id is None and "afk_channel_id" in self.model_fields_set:
            _dict['afk_channel_id'] = None

        # set to None if system_channel_id (nullable) is None
        # and model_fields_set contains the field
        if self.system_channel_id is None and "system_channel_id" in self.model_fields_set:
            _dict['system_channel_id'] = None
        ...
        # set to None if rules_channel_id (nullable) is None
        # and model_fields_set contains the field
        if self.rules_channel_id is None and "rules_channel_id" in self.model_fields_set:
            _dict['rules_channel_id'] = None

        # set to None if safety_alerts_channel_id (nullable) is None
        # and model_fields_set contains the field
        if self.safety_alerts_channel_id is None and "safety_alerts_channel_id" in self.model_fields_set:
            _dict['safety_alerts_channel_id'] = None

        # set to None if public_updates_channel_id (nullable) is None
        # and model_fields_set contains the field
        if self.public_updates_channel_id is None and "public_updates_channel_id" in self.model_fields_set:
            _dict['public_updates_channel_id'] = None
