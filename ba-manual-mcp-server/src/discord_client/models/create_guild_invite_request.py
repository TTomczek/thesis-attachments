...
class CreateGuildInviteRequest(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if target_application_id (nullable) is None
        # and model_fields_set contains the field
        if self.target_application_id is None and "target_application_id" in self.model_fields_set:
            _dict['target_application_id'] = None
