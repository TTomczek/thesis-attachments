...
class SearchApi:
    ...
    @validate_call
    async def get_characters_character_id_search(
        self,
    ...
    @validate_call
    async def get_characters_character_id_search_with_http_info(
        self,
        categories: Annotated[List[StrictStr], Field(min_length=1, max_length=11)],
        character_id: Annotated[StrictInt, Field(description="The ID of the character")],
        search: Annotated[str, Field(min_length=3, strict=True)],
    ...
    @validate_call
    async def get_characters_character_id_search_without_preload_content(
        self,
        categories: Annotated[List[StrictStr], Field(min_length=1, max_length=11)],
        character_id: Annotated[StrictInt, Field(description="The ID of the character")],
        search: Annotated[str, Field(min_length=3, strict=True)],
