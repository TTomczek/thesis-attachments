...
@sanitize_output()
@mcp.tool()
async def issues_list_labels_for_repo(owner: Annotated[str, Field(description="The account owner of the repository. The name is not case sensitive.")], repo: Annotated[str, Field(description="The name of the repository without the `.git` extension. The name is not case sensitive.")], per_page: Annotated[Optional[int], Field(description="The number of results per page (max 100).")] = 30, page: Annotated[Optional[int], Field(description="The page number of the results to fetch.")] = 1):
...
@sanitize_output()
@mcp.tool()
async def repos_get_branch_protection(owner: Annotated[str, Field(description="The account owner of the repository. The name is not case sensitive.")], repo: Annotated[str, Field(description="The name of the repository without the `.git` extension. The name is not case sensitive.")], branch: Annotated[str, Field(description="The name of the branch. Cannot contain wildcard characters.")]):
    """
