...
class RepositoryRuleDetailedOneOf18(BaseModel):
    """
    RepositoryRuleDetailedOneOf18
    """ # noqa: E501
    type: StrictStr
    parameters: Optional[RepositoryRuleMaxFileSizeParameters] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RepositoryRuleDetailedOneOf18 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RepositoryRuleDetailedOneOf18 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "parameters": RepositoryRuleMaxFileSizeParameters.from_dict(obj["parameters"]) if obj.get("parameters") is not None else None,
