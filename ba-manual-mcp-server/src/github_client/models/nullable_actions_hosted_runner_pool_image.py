...
class NullableActionsHostedRunnerPoolImage(BaseModel):
    ...
    version: Optional[StrictStr] = Field(default=None, description="The image version of the hosted runner pool.")
    __properties: ClassVar[List[str]] = ["id", "size_gb", "display_name", "source", "version"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NullableActionsHostedRunnerPoolImage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NullableActionsHostedRunnerPoolImage from a dict"""
        if obj is None:
            return None
