...
class OrganizationFull(BaseModel):
    ...
    default_repository_branch: Optional[StrictStr] = Field(default=None, description="The default branch for repositories created in this organization.")
    ...
    members_can_delete_repositories: Optional[StrictBool] = None
    members_can_change_repo_visibility: Optional[StrictBool] = None
    members_can_invite_outside_collaborators: Optional[StrictBool] = None
    members_can_delete_issues: Optional[StrictBool] = None
    display_commenter_full_name_setting_enabled: Optional[StrictBool] = None
    readers_can_create_discussions: Optional[StrictBool] = None
    members_can_create_teams: Optional[StrictBool] = None
    members_can_view_dependency_insights: Optional[StrictBool] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if default_repository_branch (nullable) is None
        # and model_fields_set contains the field
        if self.default_repository_branch is None and "default_repository_branch" in self.model_fields_set:
            _dict['default_repository_branch'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "default_repository_branch": obj.get("default_repository_branch"),
            ...
            "members_can_delete_repositories": obj.get("members_can_delete_repositories"),
            "members_can_change_repo_visibility": obj.get("members_can_change_repo_visibility"),
            "members_can_invite_outside_collaborators": obj.get("members_can_invite_outside_collaborators"),
            "members_can_delete_issues": obj.get("members_can_delete_issues"),
            "display_commenter_full_name_setting_enabled": obj.get("display_commenter_full_name_setting_enabled"),
            "readers_can_create_discussions": obj.get("readers_can_create_discussions"),
            "members_can_create_teams": obj.get("members_can_create_teams"),
            "members_can_view_dependency_insights": obj.get("members_can_view_dependency_insights"),
