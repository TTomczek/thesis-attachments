...
class WebhooksRelease1(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["assets", "assets_url", "author", "body", "created_at", "discussion_url", "draft", "html_url", "id", "immutable", "name", "node_id", "prerelease", "published_at", "reactions", "tag_name", "tarball_url", "target_commitish", "updated_at", "upload_url", "url", "zipball_url"]
