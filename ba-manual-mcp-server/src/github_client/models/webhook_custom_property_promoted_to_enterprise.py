...
class WebhookCustomPropertyPromotedToEnterprise(BaseModel):
    ...
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['promote_to_enterprise']):
            raise ValueError("must be one of enum values ('promote_to_enterprise')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebhookCustomPropertyPromotedToEnterprise from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebhookCustomPropertyPromotedToEnterprise from a dict"""
        if obj is None:
            return None
