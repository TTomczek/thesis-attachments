...
class RepositoryRulePullRequestParameters(BaseModel):
    ...
    required_reviewers: Optional[List[RepositoryRuleParamsRequiredReviewerConfiguration]] = Field(default=None, description="> [!NOTE] > `required_reviewers` is in beta and subject to change.  A collection of reviewers and associated file patterns. Each reviewer has a list of file patterns which determine the files that reviewer is required to review.")
    __properties: ClassVar[List[str]] = ["allowed_merge_methods", "automatic_copilot_code_review_enabled", "dismiss_stale_reviews_on_push", "require_code_owner_review", "require_last_push_approval", "required_approving_review_count", "required_review_thread_resolution", "required_reviewers"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in required_reviewers (list)
        _items = []
        if self.required_reviewers:
            for _item_required_reviewers in self.required_reviewers:
                if _item_required_reviewers:
                    _items.append(_item_required_reviewers.to_dict())
            _dict['required_reviewers'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "required_reviewers": [RepositoryRuleParamsRequiredReviewerConfiguration.from_dict(_item) for _item in obj["required_reviewers"]] if obj.get("required_reviewers") is not None else None
        })
        return _obj
