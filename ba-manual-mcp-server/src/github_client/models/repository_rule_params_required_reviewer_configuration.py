...
class RepositoryRuleParamsRequiredReviewerConfiguration(BaseModel):
    ...
    """ # noqa: E501
    file_patterns: List[StrictStr] = Field(description="Array of file patterns. Pull requests which change matching files must be approved by the specified team. File patterns use fnmatch syntax.")
