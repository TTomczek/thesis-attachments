...
class App3Permissions(BaseModel):
    ...
    merge_queues: Optional[StrictStr] = None
    ...
    def attestations_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    @field_validator('merge_queues')
    def merge_queues_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of App3Permissions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of App3Permissions from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "merge_queues": obj.get("merge_queues"),
