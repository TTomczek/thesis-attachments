...
class RateLimitOverviewResources(BaseModel):
    ...
    dependency_sbom: Optional[RateLimit] = None
    code_scanning_autofix: Optional[RateLimit] = None
    __properties: ClassVar[List[str]] = ["core", "graphql", "search", "code_search", "source_import", "integration_manifest", "code_scanning_upload", "actions_runner_registration", "scim", "dependency_snapshots", "dependency_sbom", "code_scanning_autofix"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of dependency_sbom
        if self.dependency_sbom:
            _dict['dependency_sbom'] = self.dependency_sbom.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dependency_sbom": RateLimit.from_dict(obj["dependency_sbom"]) if obj.get("dependency_sbom") is not None else None,
