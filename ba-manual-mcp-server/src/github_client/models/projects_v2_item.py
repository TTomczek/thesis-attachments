...
class ProjectsV2Item(BaseModel):
    ...
    project_node_id: Optional[StrictStr] = Field(default=None, description="The node ID of the project that contains this item.")
    content_node_id: StrictStr = Field(description="The node ID of the content represented by this item.")
