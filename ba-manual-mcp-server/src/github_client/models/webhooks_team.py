...
class WebhooksTeam(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default=None, description="The ownership type of the team")
    ...
    __properties: ClassVar[List[str]] = ["deleted", "description", "html_url", "id", "members_url", "name", "node_id", "parent", "permission", "privacy", "notification_setting", "repositories_url", "slug", "url", "type", "organization_id", "enterprise_id"]
