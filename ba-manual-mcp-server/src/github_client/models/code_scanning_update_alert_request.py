...
class CodeScanningUpdateAlertRequest(BaseModel):
    ...
    create_request: Optional[StrictBool] = Field(default=None, description="If `true`, attempt to create an alert dismissal request.")
    __properties: ClassVar[List[str]] = ["state", "dismissed_reason", "dismissed_comment", "create_request"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "create_request": obj.get("create_request")
        })
        return _obj
