...
class Issue6(BaseModel):
    ...
    assignees: Optional[List[Optional[User2]]] = None
    author_association: Optional[StrictStr] = Field(default=None, description="How the author is associated with the repository.")
