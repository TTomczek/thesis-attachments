...
class RepositoryRuleDetailedOneOf21(BaseModel):
    """
    RepositoryRuleDetailedOneOf21
    """ # noqa: E501
    type: StrictStr
    parameters: Optional[RepositoryRuleCopilotCodeReviewParameters] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['copilot_code_review']):
            raise ValueError("must be one of enum values ('copilot_code_review')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RepositoryRuleDetailedOneOf21 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RepositoryRuleDetailedOneOf21 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "parameters": RepositoryRuleCopilotCodeReviewParameters.from_dict(obj["parameters"]) if obj.get("parameters") is not None else None,
