...
class ReposCreateOrgRulesetRequest(BaseModel):
    ...
    rules: Optional[List[OrgRules]] = Field(default=None, description="An array of rules within the ruleset.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rules": [OrgRules.from_dict(_item) for _item in obj["rules"]] if obj.get("rules") is not None else None
        })
        return _obj
