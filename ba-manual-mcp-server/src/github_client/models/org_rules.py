...
ORGRULES_ONE_OF_SCHEMAS = ["RepositoryRuleBranchNamePattern", "RepositoryRuleCodeScanning", "RepositoryRuleCommitAuthorEmailPattern", "RepositoryRuleCommitMessagePattern", "RepositoryRuleCommitterEmailPattern", "RepositoryRuleCreation", "RepositoryRuleDeletion", "RepositoryRuleFileExtensionRestriction", "RepositoryRuleFilePathRestriction", "RepositoryRuleMaxFilePathLength", "RepositoryRuleMaxFileSize", "RepositoryRuleNonFastForward", "RepositoryRulePullRequest", "RepositoryRuleRequiredDeployments", "RepositoryRuleRequiredLinearHistory", "RepositoryRuleRequiredSignatures", "RepositoryRuleRequiredStatusChecks", "RepositoryRuleTagNamePattern", "RepositoryRuleUpdate", "RepositoryRuleWorkflows"]
...
class OrgRules(BaseModel):
    ...
    oneof_schema_5_validator: Optional[RepositoryRuleRequiredDeployments] = None
    # data type: RepositoryRuleRequiredSignatures
    oneof_schema_6_validator: Optional[RepositoryRuleRequiredSignatures] = None
    # data type: RepositoryRulePullRequest
    oneof_schema_7_validator: Optional[RepositoryRulePullRequest] = None
    # data type: RepositoryRuleRequiredStatusChecks
    oneof_schema_8_validator: Optional[RepositoryRuleRequiredStatusChecks] = None
    # data type: RepositoryRuleNonFastForward
    oneof_schema_9_validator: Optional[RepositoryRuleNonFastForward] = None
    # data type: RepositoryRuleCommitMessagePattern
    oneof_schema_10_validator: Optional[RepositoryRuleCommitMessagePattern] = None
    # data type: RepositoryRuleCommitAuthorEmailPattern
    oneof_schema_11_validator: Optional[RepositoryRuleCommitAuthorEmailPattern] = None
    # data type: RepositoryRuleCommitterEmailPattern
    oneof_schema_12_validator: Optional[RepositoryRuleCommitterEmailPattern] = None
    # data type: RepositoryRuleBranchNamePattern
    oneof_schema_13_validator: Optional[RepositoryRuleBranchNamePattern] = None
    # data type: RepositoryRuleTagNamePattern
    oneof_schema_14_validator: Optional[RepositoryRuleTagNamePattern] = None
    # data type: RepositoryRuleFilePathRestriction
    oneof_schema_15_validator: Optional[RepositoryRuleFilePathRestriction] = None
    # data type: RepositoryRuleMaxFilePathLength
    oneof_schema_16_validator: Optional[RepositoryRuleMaxFilePathLength] = None
    # data type: RepositoryRuleFileExtensionRestriction
    oneof_schema_17_validator: Optional[RepositoryRuleFileExtensionRestriction] = None
    # data type: RepositoryRuleMaxFileSize
    oneof_schema_18_validator: Optional[RepositoryRuleMaxFileSize] = None
    # data type: RepositoryRuleWorkflows
    oneof_schema_19_validator: Optional[RepositoryRuleWorkflows] = None
    # data type: RepositoryRuleCodeScanning
    oneof_schema_20_validator: Optional[RepositoryRuleCodeScanning] = None
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = OrgRules.model_construct()
        error_messages = []
        match = 0
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in OrgRules with oneOf schemas: RepositoryRuleBranchNamePattern, RepositoryRuleCodeScanning, RepositoryRuleCommitAuthorEmailPattern, RepositoryRuleCommitMessagePattern, RepositoryRuleCommitterEmailPattern, RepositoryRuleCreation, RepositoryRuleDeletion, RepositoryRuleFileExtensionRestriction, RepositoryRuleFilePathRestriction, RepositoryRuleMaxFilePathLength, RepositoryRuleMaxFileSize, RepositoryRuleNonFastForward, RepositoryRulePullRequest, RepositoryRuleRequiredDeployments, RepositoryRuleRequiredLinearHistory, RepositoryRuleRequiredSignatures, RepositoryRuleRequiredStatusChecks, RepositoryRuleTagNamePattern, RepositoryRuleUpdate, RepositoryRuleWorkflows. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in OrgRules with oneOf schemas: RepositoryRuleBranchNamePattern, RepositoryRuleCodeScanning, RepositoryRuleCommitAuthorEmailPattern, RepositoryRuleCommitMessagePattern, RepositoryRuleCommitterEmailPattern, RepositoryRuleCreation, RepositoryRuleDeletion, RepositoryRuleFileExtensionRestriction, RepositoryRuleFilePathRestriction, RepositoryRuleMaxFilePathLength, RepositoryRuleMaxFileSize, RepositoryRuleNonFastForward, RepositoryRulePullRequest, RepositoryRuleRequiredDeployments, RepositoryRuleRequiredLinearHistory, RepositoryRuleRequiredSignatures, RepositoryRuleRequiredStatusChecks, RepositoryRuleTagNamePattern, RepositoryRuleUpdate, RepositoryRuleWorkflows. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into OrgRules with oneOf schemas: RepositoryRuleBranchNamePattern, RepositoryRuleCodeScanning, RepositoryRuleCommitAuthorEmailPattern, RepositoryRuleCommitMessagePattern, RepositoryRuleCommitterEmailPattern, RepositoryRuleCreation, RepositoryRuleDeletion, RepositoryRuleFileExtensionRestriction, RepositoryRuleFilePathRestriction, RepositoryRuleMaxFilePathLength, RepositoryRuleMaxFileSize, RepositoryRuleNonFastForward, RepositoryRulePullRequest, RepositoryRuleRequiredDeployments, RepositoryRuleRequiredLinearHistory, RepositoryRuleRequiredSignatures, RepositoryRuleRequiredStatusChecks, RepositoryRuleTagNamePattern, RepositoryRuleUpdate, RepositoryRuleWorkflows. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
