...
class PrivateRegistriesCreateOrgPrivateRegistryRequest(BaseModel):
    """
    PrivateRegistriesCreateOrgPrivateRegistryRequest
    """ # noqa: E501
    registry_type: StrictStr = Field(description="The registry type.")
    url: StrictStr = Field(description="The URL of the private registry.")
    ...
    replaces_base: Optional[StrictBool] = Field(default=False, description="Whether this private registry should replace the base registry (e.g., npmjs.org for npm, rubygems.org for rubygems). When set to `true`, Dependabot will only use this registry and will not fall back to the public registry. When set to `false` (default), Dependabot will use this registry for scoped packages but may fall back to the public registry for other packages.")
    encrypted_value: Annotated[str, Field(strict=True)] = Field(description="The value for your secret, encrypted with [LibSodium](https://libsodium.gitbook.io/doc/bindings_for_other_languages) using the public key retrieved from the [Get private registries public key for an organization](https://docs.github.com/rest/private-registries/organization-configurations#get-private-registries-public-key-for-an-organization) endpoint.")
    key_id: StrictStr = Field(description="The ID of the key you used to encrypt the secret.")
    ...
    __properties: ClassVar[List[str]] = ["registry_type", "url", "username", "replaces_base", "encrypted_value", "key_id", "visibility", "selected_repository_ids"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PrivateRegistriesCreateOrgPrivateRegistryRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PrivateRegistriesCreateOrgPrivateRegistryRequest from a dict"""
        if obj is None:
            return None
