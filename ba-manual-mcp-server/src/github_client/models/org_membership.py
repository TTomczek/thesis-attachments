...
class OrgMembership(BaseModel):
    ...
    direct_membership: Optional[StrictBool] = Field(default=None, description="Whether the user has direct membership in the organization.")
    enterprise_teams_providing_indirect_membership: Optional[Annotated[List[StrictStr], Field(max_length=100)]] = Field(default=None, description="The slugs of the enterprise teams providing the user with indirect membership in the organization. A limit of 100 enterprise team slugs is returned.")
    organization_url: StrictStr
    organization: OrganizationSimple
    user: Optional[NullableSimpleUser]
    permissions: Optional[OrgMembershipPermissions] = None
    __properties: ClassVar[List[str]] = ["url", "state", "role", "direct_membership", "enterprise_teams_providing_indirect_membership", "organization_url", "organization", "user", "permissions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "state": obj.get("state"),
            "role": obj.get("role"),
            "direct_membership": obj.get("direct_membership"),
            "enterprise_teams_providing_indirect_membership": obj.get("enterprise_teams_providing_indirect_membership"),
