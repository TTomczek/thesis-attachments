...
class OrgsCreateArtifactStorageRecordRequest(BaseModel):
    ...
    version: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=100)]] = Field(default=None, description="The artifact version.")
    ...
    github_repository: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=100)]] = Field(default=None, description="The name of the GitHub repository associated with the artifact. This should be used when there are no provenance attestations available for the artifact. The repository must belong to the organization specified in the path parameter.  If a provenance attestation is available for the artifact, the API will use the repository information from the attestation instead of this parameter.")
    __properties: ClassVar[List[str]] = ["name", "digest", "version", "artifact_url", "path", "registry_url", "repository", "status", "github_repository"]
    ...
    def github_repository_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
