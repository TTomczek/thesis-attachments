...
class WebhookIssuesTyped(BaseModel):
    ...
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['typed']):
            raise ValueError("must be one of enum values ('typed')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebhookIssuesTyped from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebhookIssuesTyped from a dict"""
        if obj is None:
            return None
