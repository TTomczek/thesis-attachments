...
class ActionsHostedRunner(BaseModel):
    ...
    image_gen: Optional[StrictBool] = Field(default=None, description="Whether custom image generation is enabled for the hosted runners.")
    __properties: ClassVar[List[str]] = ["id", "name", "runner_group_id", "image_details", "machine_size_details", "status", "platform", "maximum_runners", "public_ip_enabled", "public_ips", "last_active_on", "image_gen"]
