...
class WebhookCodeScanningAlertClosedByUserAlert(BaseModel):
    ...
    url: StrictStr
    dismissal_approved_by: Optional[User2] = None
    __properties: ClassVar[List[str]] = ["assignees", "created_at", "dismissed_at", "dismissed_by", "dismissed_comment", "dismissed_reason", "fixed_at", "html_url", "most_recent_instance", "number", "rule", "state", "tool", "url", "dismissal_approved_by"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "url": obj.get("url"),
            "dismissal_approved_by": User2.from_dict(obj["dismissal_approved_by"]) if obj.get("dismissal_approved_by") is not None else None
        })
        return _obj
