...
class CodeScanningAlertItems(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["number", "created_at", "updated_at", "url", "html_url", "instances_url", "state", "fixed_at", "dismissed_by", "dismissed_at", "dismissed_reason", "dismissed_comment", "rule", "tool", "most_recent_instance", "dismissal_approved_by", "assignees"]
