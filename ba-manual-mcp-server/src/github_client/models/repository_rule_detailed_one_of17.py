...
class RepositoryRuleDetailedOneOf17(BaseModel):
    """
    RepositoryRuleDetailedOneOf17
    """ # noqa: E501
    type: StrictStr
    parameters: Optional[RepositoryRuleFileExtensionRestrictionParameters] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RepositoryRuleDetailedOneOf17 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RepositoryRuleDetailedOneOf17 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "parameters": RepositoryRuleFileExtensionRestrictionParameters.from_dict(obj["parameters"]) if obj.get("parameters") is not None else None,
