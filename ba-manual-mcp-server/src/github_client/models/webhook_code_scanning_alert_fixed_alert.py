...
class WebhookCodeScanningAlertFixedAlert(BaseModel):
    ...
    url: StrictStr
    __properties: ClassVar[List[str]] = ["assignees", "created_at", "dismissed_at", "dismissed_by", "dismissed_comment", "dismissed_reason", "fixed_at", "html_url", "instances_url", "most_recent_instance", "number", "rule", "state", "tool", "url"]
