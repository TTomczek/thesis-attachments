...
class WebhookCodeScanningAlertCreatedAlert(BaseModel):
    ...
    fixed_at: Optional[Any] = Field(default=None, description="The time that the alert was fixed in ISO 8601 format: `YYYY-MM-DDTHH:MM:SSZ`.")
    ...
    state: Optional[StrictStr] = Field(description="State of a code scanning alert. Events for alerts found outside the default branch will return a `null` value until they are dismissed or fixed.")
    tool: Optional[WebhookCodeScanningAlertCreatedAlertTool]
    updated_at: Optional[StrictStr] = None
    url: StrictStr
    dismissal_approved_by: Optional[Any] = None
    assignees: Optional[List[SimpleUser]] = None
    __properties: ClassVar[List[str]] = ["created_at", "dismissed_at", "dismissed_by", "dismissed_comment", "dismissed_reason", "fixed_at", "html_url", "instances_url", "most_recent_instance", "number", "rule", "state", "tool", "updated_at", "url", "dismissal_approved_by", "assignees"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "url": obj.get("url"),
            "dismissal_approved_by": obj.get("dismissal_approved_by"),
