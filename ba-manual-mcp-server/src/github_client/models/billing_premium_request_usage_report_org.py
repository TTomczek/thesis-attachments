...
class BillingPremiumRequestUsageReportOrg(BaseModel):
    """
    ...
    user: Optional[StrictStr] = Field(default=None, description="The name of the user for the usage report.")
    ...
    __properties: ClassVar[List[str]] = ["timePeriod", "organization", "user", "product", "model", "usageItems"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BillingPremiumRequestUsageReportOrg from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BillingPremiumRequestUsageReportOrg from a dict"""
        if obj is None:
            return None
