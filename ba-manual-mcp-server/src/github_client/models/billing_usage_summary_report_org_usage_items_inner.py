...
class BillingUsageSummaryReportOrgUsageItemsInner(BaseModel):
    """
    ...
    gross_quantity: Union[StrictFloat, StrictInt] = Field(description="Gross quantity of the usage line item.", alias="grossQuantity")
    gross_amount: Union[StrictFloat, StrictInt] = Field(description="Gross amount of the usage line item.", alias="grossAmount")
    discount_quantity: Union[StrictFloat, StrictInt] = Field(description="Discount quantity of the usage line item.", alias="discountQuantity")
    ...
    net_quantity: Union[StrictFloat, StrictInt] = Field(description="Net quantity of the usage line item.", alias="netQuantity")
    net_amount: Union[StrictFloat, StrictInt] = Field(description="Net amount of the usage line item.", alias="netAmount")
    __properties: ClassVar[List[str]] = ["product", "sku", "unitType", "pricePerUnit", "grossQuantity", "grossAmount", "discountQuantity", "discountAmount", "netQuantity", "netAmount"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BillingUsageSummaryReportOrgUsageItemsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BillingUsageSummaryReportOrgUsageItemsInner from a dict"""
        if obj is None:
            return None
