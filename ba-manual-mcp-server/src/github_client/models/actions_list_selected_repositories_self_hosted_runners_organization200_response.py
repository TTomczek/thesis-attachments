...
class ActionsListSelectedRepositoriesSelfHostedRunnersOrganization200Response(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ActionsListSelectedRepositoriesSelfHostedRunnersOrganization200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ActionsListSelectedRepositoriesSelfHostedRunnersOrganization200Response from a dict"""
        if obj is None:
            return None
