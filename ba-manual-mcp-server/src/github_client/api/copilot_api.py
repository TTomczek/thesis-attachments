...
class CopilotApi:
    ...
    @validate_call
    async def copilot_add_copilot_seats_for_teams(
        self,
    ...
    @validate_call
    async def copilot_add_copilot_seats_for_teams_with_http_info(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
        copilot_add_copilot_seats_for_teams_request: CopilotAddCopilotSeatsForTeamsRequest,
        _request_timeout: Union[
    ...
    @validate_call
    async def copilot_add_copilot_seats_for_teams_without_preload_content(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
        copilot_add_copilot_seats_for_teams_request: CopilotAddCopilotSeatsForTeamsRequest,
        _request_timeout: Union[
    ...
    @validate_call
    async def copilot_add_copilot_seats_for_users(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
    ...
    @validate_call
    async def copilot_add_copilot_seats_for_users_with_http_info(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
        copilot_add_copilot_seats_for_users_request: CopilotAddCopilotSeatsForUsersRequest,
        _request_timeout: Union[
    ...
    @validate_call
    async def copilot_add_copilot_seats_for_users_without_preload_content(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
        copilot_add_copilot_seats_for_users_request: CopilotAddCopilotSeatsForUsersRequest,
        _request_timeout: Union[
    ...
    @validate_call
    async def copilot_cancel_copilot_seat_assignment_for_teams(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
    ...
    @validate_call
    async def copilot_cancel_copilot_seat_assignment_for_teams_with_http_info(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
        copilot_cancel_copilot_seat_assignment_for_teams_request: CopilotCancelCopilotSeatAssignmentForTeamsRequest,
        _request_timeout: Union[
    ...
    @validate_call
    async def copilot_cancel_copilot_seat_assignment_for_teams_without_preload_content(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
        copilot_cancel_copilot_seat_assignment_for_teams_request: CopilotCancelCopilotSeatAssignmentForTeamsRequest,
        _request_timeout: Union[
    ...
    @validate_call
    async def copilot_cancel_copilot_seat_assignment_for_users(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
    ...
    @validate_call
    async def copilot_cancel_copilot_seat_assignment_for_users_with_http_info(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
        copilot_cancel_copilot_seat_assignment_for_users_request: CopilotCancelCopilotSeatAssignmentForUsersRequest,
        _request_timeout: Union[
    ...
    @validate_call
    async def copilot_cancel_copilot_seat_assignment_for_users_without_preload_content(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
        copilot_cancel_copilot_seat_assignment_for_users_request: CopilotCancelCopilotSeatAssignmentForUsersRequest,
        _request_timeout: Union[
    ...
    @validate_call
    async def copilot_copilot_metrics_for_organization(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
        since: Annotated[Optional[StrictStr], Field(description="Show usage metrics since this date. This is a timestamp in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format (`YYYY-MM-DDTHH:MM:SSZ`). Maximum value is 100 days ago.")] = None,
        ...
        per_page: Annotated[Optional[StrictInt], Field(description="The number of days of metrics to display per page (max 100). For more information, see \"[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\"")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param org: The organization name. The name is not case sensitive. (required)
        :type org: str
        :param since: Show usage metrics since this date. This is a timestamp in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format (`YYYY-MM-DDTHH:MM:SSZ`). Maximum value is 100 days ago.
        :type since: str
        ...
        :type page: int
        :param per_page: The number of days of metrics to display per page (max 100). For more information, see \"[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\"
        :type per_page: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    @validate_call
    async def copilot_copilot_metrics_for_organization_with_http_info(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
        since: Annotated[Optional[StrictStr], Field(description="Show usage metrics since this date. This is a timestamp in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format (`YYYY-MM-DDTHH:MM:SSZ`). Maximum value is 100 days ago.")] = None,
        until: Annotated[Optional[StrictStr], Field(description="Show usage metrics until this date. This is a timestamp in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format (`YYYY-MM-DDTHH:MM:SSZ`) and should not preceed the `since` date if it is passed.")] = None,
    ...
    @validate_call
    async def copilot_copilot_metrics_for_organization_without_preload_content(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
        since: Annotated[Optional[StrictStr], Field(description="Show usage metrics since this date. This is a timestamp in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format (`YYYY-MM-DDTHH:MM:SSZ`). Maximum value is 100 days ago.")] = None,
        until: Annotated[Optional[StrictStr], Field(description="Show usage metrics until this date. This is a timestamp in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format (`YYYY-MM-DDTHH:MM:SSZ`) and should not preceed the `since` date if it is passed.")] = None,
    ...
    @validate_call
    async def copilot_copilot_metrics_for_team(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
    ...
    @validate_call
    async def copilot_copilot_metrics_for_team_with_http_info(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
        team_slug: Annotated[StrictStr, Field(description="The slug of the team name.")],
        since: Annotated[Optional[StrictStr], Field(description="Show usage metrics since this date. This is a timestamp in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format (`YYYY-MM-DDTHH:MM:SSZ`). Maximum value is 100 days ago.")] = None,
    ...
    @validate_call
    async def copilot_copilot_metrics_for_team_without_preload_content(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
        team_slug: Annotated[StrictStr, Field(description="The slug of the team name.")],
        since: Annotated[Optional[StrictStr], Field(description="Show usage metrics since this date. This is a timestamp in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format (`YYYY-MM-DDTHH:MM:SSZ`). Maximum value is 100 days ago.")] = None,
    ...
    @validate_call
    async def copilot_get_copilot_organization_details(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def copilot_get_copilot_organization_details_with_http_info(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def copilot_get_copilot_organization_details_without_preload_content(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def copilot_get_copilot_seat_details_for_user(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
    ...
    @validate_call
    async def copilot_get_copilot_seat_details_for_user_with_http_info(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
        username: Annotated[StrictStr, Field(description="The handle for the GitHub user account.")],
        _request_timeout: Union[
    ...
    @validate_call
    async def copilot_get_copilot_seat_details_for_user_without_preload_content(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
        username: Annotated[StrictStr, Field(description="The handle for the GitHub user account.")],
        _request_timeout: Union[
    ...
    @validate_call
    async def copilot_list_copilot_seats(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
        page: Annotated[Optional[StrictInt], Field(description="The page number of the results to fetch. For more information, see \"[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\"")] = None,
    ...
    @validate_call
    async def copilot_list_copilot_seats_with_http_info(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
        page: Annotated[Optional[StrictInt], Field(description="The page number of the results to fetch. For more information, see \"[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\"")] = None,
        per_page: Annotated[Optional[StrictInt], Field(description="The number of results per page (max 100). For more information, see \"[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\"")] = None,
    ...
    @validate_call
    async def copilot_list_copilot_seats_without_preload_content(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
        page: Annotated[Optional[StrictInt], Field(description="The page number of the results to fetch. For more information, see \"[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\"")] = None,
        per_page: Annotated[Optional[StrictInt], Field(description="The number of results per page (max 100). For more information, see \"[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\"")] = None,
