...
class CampaignsApi:
    ...
    @validate_call
    async def campaigns_create_campaign(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
        campaigns_create_campaign_request: Optional[CampaignsCreateCampaignRequest],
    ...
    @validate_call
    async def campaigns_create_campaign_with_http_info(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
        campaigns_create_campaign_request: Optional[CampaignsCreateCampaignRequest],
        _request_timeout: Union[
    ...
    @validate_call
    async def campaigns_create_campaign_without_preload_content(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
        campaigns_create_campaign_request: Optional[CampaignsCreateCampaignRequest],
        _request_timeout: Union[
    ...
    @validate_call
    async def campaigns_delete_campaign(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
    ...
    @validate_call
    async def campaigns_delete_campaign_with_http_info(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
        campaign_number: Annotated[StrictInt, Field(description="The campaign number.")],
        _request_timeout: Union[
    ...
    @validate_call
    async def campaigns_delete_campaign_without_preload_content(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
        campaign_number: Annotated[StrictInt, Field(description="The campaign number.")],
        _request_timeout: Union[
    ...
    @validate_call
    async def campaigns_get_campaign_summary(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
        campaign_number: Annotated[StrictInt, Field(description="The campaign number.")],
        _request_timeout: Union[
    ...
    @validate_call
    async def campaigns_get_campaign_summary_with_http_info(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
        campaign_number: Annotated[StrictInt, Field(description="The campaign number.")],
        _request_timeout: Union[
    ...
    @validate_call
    async def campaigns_get_campaign_summary_without_preload_content(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
        campaign_number: Annotated[StrictInt, Field(description="The campaign number.")],
        _request_timeout: Union[
    ...
    @validate_call
    async def campaigns_list_org_campaigns(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
    ...
    @validate_call
    async def campaigns_list_org_campaigns_with_http_info(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
        page: Annotated[Optional[StrictInt], Field(description="The page number of the results to fetch. For more information, see \"[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\"")] = None,
        per_page: Annotated[Optional[StrictInt], Field(description="The number of results per page (max 100). For more information, see \"[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\"")] = None,
    ...
    @validate_call
    async def campaigns_list_org_campaigns_without_preload_content(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
        page: Annotated[Optional[StrictInt], Field(description="The page number of the results to fetch. For more information, see \"[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\"")] = None,
        per_page: Annotated[Optional[StrictInt], Field(description="The number of results per page (max 100). For more information, see \"[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\"")] = None,
    ...
    @validate_call
    async def campaigns_update_campaign(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
        campaign_number: Annotated[StrictInt, Field(description="The campaign number.")],
    ...
    @validate_call
    async def campaigns_update_campaign_with_http_info(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
        campaign_number: Annotated[StrictInt, Field(description="The campaign number.")],
        campaigns_update_campaign_request: CampaignsUpdateCampaignRequest,
    ...
    @validate_call
    async def campaigns_update_campaign_without_preload_content(
        self,
        org: Annotated[StrictStr, Field(description="The organization name. The name is not case sensitive.")],
        campaign_number: Annotated[StrictInt, Field(description="The campaign number.")],
        campaigns_update_campaign_request: CampaignsUpdateCampaignRequest,
