...
class ChecksApi:
    ...
    @validate_call
    async def checks_create_with_http_info(
        self,
        owner: Annotated[StrictStr, Field(description="The account owner of the repository. The name is not case sensitive.")],
        repo: Annotated[StrictStr, Field(description="The name of the repository without the `.git` extension. The name is not case sensitive.")],
        checks_create_request: ChecksCreateRequest,
    ...
    @validate_call
    async def checks_create_without_preload_content(
        self,
        owner: Annotated[StrictStr, Field(description="The account owner of the repository. The name is not case sensitive.")],
        repo: Annotated[StrictStr, Field(description="The name of the repository without the `.git` extension. The name is not case sensitive.")],
        checks_create_request: ChecksCreateRequest,
    ...
    @validate_call
    async def checks_create_suite_with_http_info(
        self,
        owner: Annotated[StrictStr, Field(description="The account owner of the repository. The name is not case sensitive.")],
        repo: Annotated[StrictStr, Field(description="The name of the repository without the `.git` extension. The name is not case sensitive.")],
        checks_create_suite_request: ChecksCreateSuiteRequest,
    ...
    @validate_call
    async def checks_create_suite_without_preload_content(
        self,
        owner: Annotated[StrictStr, Field(description="The account owner of the repository. The name is not case sensitive.")],
        repo: Annotated[StrictStr, Field(description="The name of the repository without the `.git` extension. The name is not case sensitive.")],
        checks_create_suite_request: ChecksCreateSuiteRequest,
    ...
    @validate_call
    async def checks_get_with_http_info(
        self,
        owner: Annotated[StrictStr, Field(description="The account owner of the repository. The name is not case sensitive.")],
        repo: Annotated[StrictStr, Field(description="The name of the repository without the `.git` extension. The name is not case sensitive.")],
        check_run_id: Annotated[StrictInt, Field(description="The unique identifier of the check run.")],
    ...
    @validate_call
    async def checks_get_without_preload_content(
        self,
        owner: Annotated[StrictStr, Field(description="The account owner of the repository. The name is not case sensitive.")],
        repo: Annotated[StrictStr, Field(description="The name of the repository without the `.git` extension. The name is not case sensitive.")],
        check_run_id: Annotated[StrictInt, Field(description="The unique identifier of the check run.")],
    ...
    @validate_call
    async def checks_get_suite_with_http_info(
        self,
        owner: Annotated[StrictStr, Field(description="The account owner of the repository. The name is not case sensitive.")],
        repo: Annotated[StrictStr, Field(description="The name of the repository without the `.git` extension. The name is not case sensitive.")],
        check_suite_id: Annotated[StrictInt, Field(description="The unique identifier of the check suite.")],
    ...
    @validate_call
    async def checks_get_suite_without_preload_content(
        self,
        owner: Annotated[StrictStr, Field(description="The account owner of the repository. The name is not case sensitive.")],
        repo: Annotated[StrictStr, Field(description="The name of the repository without the `.git` extension. The name is not case sensitive.")],
        check_suite_id: Annotated[StrictInt, Field(description="The unique identifier of the check suite.")],
    ...
    @validate_call
    async def checks_list_annotations(
        self,
        owner: Annotated[StrictStr, Field(description="The account owner of the repository. The name is not case sensitive.")],
        repo: Annotated[StrictStr, Field(description="The name of the repository without the `.git` extension. The name is not case sensitive.")],
        check_run_id: Annotated[StrictInt, Field(description="The unique identifier of the check run.")],
    ...
    @validate_call
    async def checks_list_annotations_with_http_info(
        self,
        owner: Annotated[StrictStr, Field(description="The account owner of the repository. The name is not case sensitive.")],
        repo: Annotated[StrictStr, Field(description="The name of the repository without the `.git` extension. The name is not case sensitive.")],
        check_run_id: Annotated[StrictInt, Field(description="The unique identifier of the check run.")],
    ...
    @validate_call
    async def checks_list_annotations_without_preload_content(
        self,
        owner: Annotated[StrictStr, Field(description="The account owner of the repository. The name is not case sensitive.")],
        repo: Annotated[StrictStr, Field(description="The name of the repository without the `.git` extension. The name is not case sensitive.")],
        check_run_id: Annotated[StrictInt, Field(description="The unique identifier of the check run.")],
    ...
    @validate_call
    async def checks_list_for_ref_with_http_info(
        self,
        owner: Annotated[StrictStr, Field(description="The account owner of the repository. The name is not case sensitive.")],
        repo: Annotated[StrictStr, Field(description="The name of the repository without the `.git` extension. The name is not case sensitive.")],
        ref: Annotated[StrictStr, Field(description="The commit reference. Can be a commit SHA, branch name (`heads/BRANCH_NAME`), or tag name (`tags/TAG_NAME`). For more information, see \"[Git References](https://git-scm.com/book/en/v2/Git-Internals-Git-References)\" in the Git documentation.")],
    ...
    @validate_call
    async def checks_list_for_ref_without_preload_content(
        self,
        owner: Annotated[StrictStr, Field(description="The account owner of the repository. The name is not case sensitive.")],
        repo: Annotated[StrictStr, Field(description="The name of the repository without the `.git` extension. The name is not case sensitive.")],
        ref: Annotated[StrictStr, Field(description="The commit reference. Can be a commit SHA, branch name (`heads/BRANCH_NAME`), or tag name (`tags/TAG_NAME`). For more information, see \"[Git References](https://git-scm.com/book/en/v2/Git-Internals-Git-References)\" in the Git documentation.")],
    ...
    @validate_call
    async def checks_list_for_suite(
        self,
        owner: Annotated[StrictStr, Field(description="The account owner of the repository. The name is not case sensitive.")],
        repo: Annotated[StrictStr, Field(description="The name of the repository without the `.git` extension. The name is not case sensitive.")],
        check_suite_id: Annotated[StrictInt, Field(description="The unique identifier of the check suite.")],
    ...
    @validate_call
    async def checks_list_for_suite_with_http_info(
        self,
        owner: Annotated[StrictStr, Field(description="The account owner of the repository. The name is not case sensitive.")],
        repo: Annotated[StrictStr, Field(description="The name of the repository without the `.git` extension. The name is not case sensitive.")],
        check_suite_id: Annotated[StrictInt, Field(description="The unique identifier of the check suite.")],
    ...
    @validate_call
    async def checks_list_for_suite_without_preload_content(
        self,
        owner: Annotated[StrictStr, Field(description="The account owner of the repository. The name is not case sensitive.")],
        repo: Annotated[StrictStr, Field(description="The name of the repository without the `.git` extension. The name is not case sensitive.")],
        check_suite_id: Annotated[StrictInt, Field(description="The unique identifier of the check suite.")],
    ...
    @validate_call
    async def checks_list_suites_for_ref(
        self,
        owner: Annotated[StrictStr, Field(description="The account owner of the repository. The name is not case sensitive.")],
        repo: Annotated[StrictStr, Field(description="The name of the repository without the `.git` extension. The name is not case sensitive.")],
        ref: Annotated[StrictStr, Field(description="The commit reference. Can be a commit SHA, branch name (`heads/BRANCH_NAME`), or tag name (`tags/TAG_NAME`). For more information, see \"[Git References](https://git-scm.com/book/en/v2/Git-Internals-Git-References)\" in the Git documentation.")],
    ...
    @validate_call
    async def checks_list_suites_for_ref_with_http_info(
        self,
        owner: Annotated[StrictStr, Field(description="The account owner of the repository. The name is not case sensitive.")],
        repo: Annotated[StrictStr, Field(description="The name of the repository without the `.git` extension. The name is not case sensitive.")],
        ref: Annotated[StrictStr, Field(description="The commit reference. Can be a commit SHA, branch name (`heads/BRANCH_NAME`), or tag name (`tags/TAG_NAME`). For more information, see \"[Git References](https://git-scm.com/book/en/v2/Git-Internals-Git-References)\" in the Git documentation.")],
    ...
    @validate_call
    async def checks_list_suites_for_ref_without_preload_content(
        self,
        owner: Annotated[StrictStr, Field(description="The account owner of the repository. The name is not case sensitive.")],
        repo: Annotated[StrictStr, Field(description="The name of the repository without the `.git` extension. The name is not case sensitive.")],
        ref: Annotated[StrictStr, Field(description="The commit reference. Can be a commit SHA, branch name (`heads/BRANCH_NAME`), or tag name (`tags/TAG_NAME`). For more information, see \"[Git References](https://git-scm.com/book/en/v2/Git-Internals-Git-References)\" in the Git documentation.")],
    ...
    @validate_call
    async def checks_rerequest_run(
        self,
        owner: Annotated[StrictStr, Field(description="The account owner of the repository. The name is not case sensitive.")],
        repo: Annotated[StrictStr, Field(description="The name of the repository without the `.git` extension. The name is not case sensitive.")],
        check_run_id: Annotated[StrictInt, Field(description="The unique identifier of the check run.")],
    ...
    @validate_call
    async def checks_rerequest_run_with_http_info(
        self,
        owner: Annotated[StrictStr, Field(description="The account owner of the repository. The name is not case sensitive.")],
        repo: Annotated[StrictStr, Field(description="The name of the repository without the `.git` extension. The name is not case sensitive.")],
        check_run_id: Annotated[StrictInt, Field(description="The unique identifier of the check run.")],
    ...
    @validate_call
    async def checks_rerequest_run_without_preload_content(
        self,
        owner: Annotated[StrictStr, Field(description="The account owner of the repository. The name is not case sensitive.")],
        repo: Annotated[StrictStr, Field(description="The name of the repository without the `.git` extension. The name is not case sensitive.")],
        check_run_id: Annotated[StrictInt, Field(description="The unique identifier of the check run.")],
    ...
    @validate_call
    async def checks_rerequest_suite(
        self,
        owner: Annotated[StrictStr, Field(description="The account owner of the repository. The name is not case sensitive.")],
        repo: Annotated[StrictStr, Field(description="The name of the repository without the `.git` extension. The name is not case sensitive.")],
        check_suite_id: Annotated[StrictInt, Field(description="The unique identifier of the check suite.")],
    ...
    @validate_call
    async def checks_rerequest_suite_with_http_info(
        self,
        owner: Annotated[StrictStr, Field(description="The account owner of the repository. The name is not case sensitive.")],
        repo: Annotated[StrictStr, Field(description="The name of the repository without the `.git` extension. The name is not case sensitive.")],
        check_suite_id: Annotated[StrictInt, Field(description="The unique identifier of the check suite.")],
    ...
    @validate_call
    async def checks_rerequest_suite_without_preload_content(
        self,
        owner: Annotated[StrictStr, Field(description="The account owner of the repository. The name is not case sensitive.")],
        repo: Annotated[StrictStr, Field(description="The name of the repository without the `.git` extension. The name is not case sensitive.")],
        check_suite_id: Annotated[StrictInt, Field(description="The unique identifier of the check suite.")],
    ...
    @validate_call
    async def checks_set_suites_preferences(
        self,
        owner: Annotated[StrictStr, Field(description="The account owner of the repository. The name is not case sensitive.")],
        repo: Annotated[StrictStr, Field(description="The name of the repository without the `.git` extension. The name is not case sensitive.")],
    ...
    @validate_call
    async def checks_set_suites_preferences_with_http_info(
        self,
        owner: Annotated[StrictStr, Field(description="The account owner of the repository. The name is not case sensitive.")],
        repo: Annotated[StrictStr, Field(description="The name of the repository without the `.git` extension. The name is not case sensitive.")],
        checks_set_suites_preferences_request: ChecksSetSuitesPreferencesRequest,
    ...
    @validate_call
    async def checks_set_suites_preferences_without_preload_content(
        self,
        owner: Annotated[StrictStr, Field(description="The account owner of the repository. The name is not case sensitive.")],
        repo: Annotated[StrictStr, Field(description="The name of the repository without the `.git` extension. The name is not case sensitive.")],
        checks_set_suites_preferences_request: ChecksSetSuitesPreferencesRequest,
    ...
    @validate_call
    async def checks_update_with_http_info(
        self,
        owner: Annotated[StrictStr, Field(description="The account owner of the repository. The name is not case sensitive.")],
        repo: Annotated[StrictStr, Field(description="The name of the repository without the `.git` extension. The name is not case sensitive.")],
        check_run_id: Annotated[StrictInt, Field(description="The unique identifier of the check run.")],
    ...
    @validate_call
    async def checks_update_without_preload_content(
        self,
        owner: Annotated[StrictStr, Field(description="The account owner of the repository. The name is not case sensitive.")],
        repo: Annotated[StrictStr, Field(description="The name of the repository without the `.git` extension. The name is not case sensitive.")],
        check_run_id: Annotated[StrictInt, Field(description="The unique identifier of the check run.")],
